...
SYLLABUS: Dict[str, Dict[str, Dict[str, List[str]]]] = {
    "React Developer": {
        "easy": {
            "tech": [
                ...
                "Why React - Declarative, component-based, and efficient with virtual DOM.",
                "React vs Angular vs Vue - Comparison of popular frontend frameworks/libraries.",
                "What is JSX - JavaScript XML, syntax extension that looks like HTML.",
                "Virtual DOM - In-memory representation of the real DOM for efficient updates.",
                "Components - Building blocks of React applications that return UI elements.",
                "Functional vs Class Components - Modern function components vs traditional class-based components.",
                "What are Props - Data passed from parent to child components.",
                "What is State - Internal data that components manage and can change.",
                "Props vs State - Props are immutable and passed down; state is mutable and internal.",
                "What are Hooks - Functions that let you use state and lifecycle in functional components.",
                "useState Hook - Hook for adding state to functional components.",
                "useEffect Hook - Hook for side effects like data fetching or subscriptions.",
                "useContext Hook - Hook for consuming context values.",
                "useRef Hook - Hook for accessing DOM elements or storing mutable values.",
                "What is Lifting State Up - Moving state to common parent component.",
                "Conditional Rendering - Showing different UI based on conditions.",
                "List and Keys - Rendering arrays of data with unique keys for each item.",
                "Event Handling - How to handle user interactions like clicks and input.",
                "Forms in React - Controlled vs uncontrolled components.",
                "What is React Router - Library for handling navigation in React apps.",
                "What is Redux - State management library for predictable state container.",
                "Component Lifecycle - Mounting, updating, and unmounting phases.",
                "React Fragment - Group multiple elements without adding extra DOM nodes.",
                ...
                "Higher-Order Components (HOC) - Functions that take a component and return enhanced component.",
                ...
                "Refs and the DOM - Accessing DOM nodes directly.",
                "Controlled Components - Form elements whose value is controlled by React state.",
                "Uncontrolled Components - Form elements that store their own state in the DOM.",
                "PropTypes - Type-checking for component props.",
                "Default Props - Default values for props.",
                "React StrictMode - Tool for highlighting potential problems.",
                "React DevTools - Browser extension for debugging React applications.",
            ],
            "tech_allied": [
                "NPM basics - Node package manager for installing dependencies.",
                "Package.json - File that lists project dependencies and scripts.",
                "What is Babel - JavaScript compiler that converts modern JS to older versions.",
                "What is Webpack - Module bundler for JavaScript applications.",
                "Create React App - Official tool to set up a new React project.",
                "Vite - Modern build tool that's faster than traditional bundlers.",
                "ES6 Features - let/const, arrow functions, destructuring, spread operator.",
                "CSS in React - Different ways to style components (CSS files, inline styles).",
                "CSS Modules - Locally scoped CSS for components.",
                "Git Basics - Version control with commit, push, pull, branch.",
                "Browser DevTools - Using console, elements, and network tabs.",
                "REST API Basics - Understanding GET, POST, PUT, DELETE requests.",
    ...
    "UI Developer": {
        "easy": {
            "tech": [
                "What is HTML - HyperText Markup Language for structuring web content.",
                "What is CSS - Cascading Style Sheets for styling web pages.",
                "What is JavaScript - Programming language for web interactivity.",
                "HTML Elements - Basic tags like div, p, h1, img, a.",
                "HTML Attributes - Properties like class, id, src, href.",
                "CSS Selectors - Class, ID, element, and attribute selectors.",
                ...
                "Flexbox Basics - Modern layout with flex container and items.",
                "Grid Basics - Two-dimensional layout system.",
                "Responsive Design - Making websites work on different screen sizes.",
                "Media Queries - CSS rules for different viewport sizes.",
                "JavaScript Variables - var, let, and const declarations.",
                "JavaScript Data Types - String, number, boolean, object, array.",
                "JavaScript Functions - Declaring and calling functions.",
                "JavaScript Arrays - Creating and manipulating lists of data.",
                "JavaScript Objects - Key-value pairs for data structures.",
                "DOM Manipulation - Selecting and changing HTML elements with JavaScript.",
                "Event Listeners - Responding to user interactions.",
                "What is the DOM - Document Object Model tree structure.",
                "CSS Specificity - How browser decides which styles to apply.",
                "Inline vs Block Elements - How elements are displayed by default.",
                "Forms and Inputs - Creating user input fields.",
                "Semantic HTML - Using meaningful tags like header, nav, article.",
                "Browser DevTools - Inspecting and debugging web pages.",
                "Git Basics - Version control fundamentals.",
                "What is a Framework - Pre-written code libraries like Bootstrap.",
                "CSS Frameworks - Bootstrap, Tailwind CSS basics.",
                "Accessibility Basics - Making websites usable for everyone.",
            ],
            "tech_allied": [
                "Browser Basics - How browsers render web pages.",
                "HTTP vs HTTPS - Secure vs insecure web connections.",
                "Web Hosting - Where websites are stored and served from.",
                "Domain Names - Human-readable website addresses.",
                "File Paths - Relative vs absolute paths.",
                "Image Formats - JPEG, PNG, SVG, GIF differences.",
                "Text Editors - VSCode, Sublime, Atom basics.",
                "Browser Compatibility - Making sites work across browsers.",
                "Code Comments - Documenting HTML, CSS, and JavaScript.",
                "Console Logging - Debugging with console.log().",
                "Package Managers - NPM and Yarn basics.",
                "Code Validation - Checking HTML and CSS for errors.",
                "FTP Basics - Uploading files to web servers.",
                "Web Standards - W3C and modern web practices.",
            ],
        },
        "medium": {
            "tech": [
    ...
    "JavaScript Developer": {
        "easy": {
            "tech": [
                "What is JavaScript - Programming language for web interactivity.",
                "JavaScript vs Java - Two different languages with different purposes.",
                "Where JavaScript Runs - Browsers and Node.js environments.",
                "Variables in JavaScript - Storing data with var, let, and const.",
                "Data Types - String, number, boolean, null, undefined, object, symbol.",
                "typeof Operator - Checking the type of a value.",
                "Strings - Text data in single or double quotes.",
                "Numbers - Numeric data including integers and decimals.",
                "Booleans - true or false values.",
                "Arrays - Ordered lists of values.",
                "Objects - Collections of key-value pairs.",
                "Functions - Reusable blocks of code.",
                "Function Declaration - Defining functions with the function keyword.",
                "Arrow Functions - Shorter function syntax with =>.",
                "Conditional Statements - if, else if, else for decision making.",
                "Switch Statement - Multiple condition checking.",
                ...
                "Array Methods - push, pop, shift, unshift for array manipulation.",
                "String Methods - length, toUpperCase, toLowerCase, substring.",
                "Template Literals - String interpolation with backticks.",
                "Comparison Operators - ==, ===, !=, !==, <, >, <=, >=.",
                "Logical Operators - &&, ||, ! for boolean logic.",
                "What is undefined - Variable declared but not assigned.",
                "What is null - Intentional absence of value.",
                "Type Coercion - Automatic type conversion.",
                "Truthy and Falsy Values - Values that evaluate to true or false.",
                "Scope Basics - Global vs local variable access.",
                "Hoisting - Variable and function declarations moved to top.",
                "Console Methods - console.log, console.error, console.warn.",
                "Comments - Single line // and multi-line /* */ comments.",
                "Math Object - Math.random, Math.floor, Math.ceil, Math.round.",
                "Date Object - Creating and working with dates.",
                "JSON - JavaScript Object Notation for data.",
            ],
            "tech_allied": [
                "Browser Console - Running JavaScript in DevTools.",
                "HTML and JavaScript - Including scripts in web pages.",
                "Script Tag - Adding JavaScript to HTML with <script>.",
                "External JavaScript Files - Linking .js files.",
                "Node.js Basics - Running JavaScript on the server.",
                "NPM Introduction - Node Package Manager.",
                "Package.json - Project configuration file.",
                "ES6+ Features - Modern JavaScript syntax.",
                "Debugging - Using console and breakpoints.",
                "Code Editors - VSCode, Sublime for writing JavaScript.",
                "Linting - ESLint for code quality.",
                "Git Basics - Version control fundamentals.",
                "Semicolons - When to use them in JavaScript.",
    ...
    "Node JS Developer": {
        "easy": {
            "tech": [
                ...
                "Why Node.js - Non-blocking I/O for scalable server applications.",
                "Node.js vs Browser JavaScript - Differences in environment and APIs.",
                "Installing Node.js - Downloading and setting up Node.js.",
                "Running a Node Script - Using node filename.js command.",
                "What is NPM - Node Package Manager for installing libraries.",
                "package.json - Configuration file for Node projects.",
                "Installing Packages - npm install command.",
                "Modules in Node - Organizing code into reusable files.",
                "require() Function - Importing modules in Node.js.",
                "module.exports - Exporting code from a module.",
                "Core Modules - Built-in modules like fs, path, http.",
                "fs Module Basics - Reading and writing files.",
                "path Module - Working with file paths.",
                "http Module - Creating basic web servers.",
                ...
                "Console in Node - console.log, console.error.",
                "Process Object - Accessing process information.",
                "Environment Variables - Using process.env.",
                "Buffer Basics - Working with binary data.",
                "Streams Basics - Reading and writing data in chunks.",
                "Creating a Simple Server - Basic HTTP server.",
                "Handling Requests - Processing GET and POST requests.",
                "Routing Basics - Handling different URL paths.",
                "JSON in Node - Parsing and stringifying JSON.",
                "File System Operations - Creating, deleting files and directories.",
                "What is Express - Popular Node.js web framework.",
                "Middleware Concept - Functions that process requests.",
                "Node.js Event Emitter - Publishing and subscribing to events.",
            ],
            "tech_allied": [
                "Command Line Basics - Running commands in terminal.",
                "npm Commands - install, start, test, run.",
                "node_modules Folder - Where dependencies are stored.",
                "package-lock.json - Locking dependency versions.",
                "Semantic Versioning - Understanding version numbers.",
                "Git Basics - Version control for Node projects.",
                ".gitignore - Excluding files from Git.",
                "REST API Basics - Understanding API endpoints.",
                "HTTP Methods - GET, POST, PUT, DELETE.",
                "HTTP Status Codes - 200, 404, 500 meanings.",
                "Postman Basics - Testing API endpoints.",
                "Environment Setup - Development vs production.",
                "Debugging Node Apps - Using debugger and console.",
    ...
    "Express JS Developer": {
        "easy": {
            "tech": [
                "What is Express - Minimal web framework for Node.js.",
                "Why Express - Simplifies building web servers and APIs.",
                "Installing Express - npm install express command.",
                "Creating an Express App - const app = express().",
                "Starting a Server - app.listen() method.",
                "Routes in Express - Handling different URL paths.",
                "app.get() - Handling GET requests.",
                "app.post() - Handling POST requests.",
                "Request Object (req) - Accessing request data.",
                "Response Object (res) - Sending responses to client.",
                "res.send() - Sending simple responses.",
                "res.json() - Sending JSON responses.",
                "Route Parameters - Dynamic URL segments like :id.",
                "Query Parameters - URL parameters after ? symbol.",
                "What is Middleware - Functions that process requests.",
                "app.use() - Applying middleware.",
                "Static Files - Serving HTML, CSS, images with express.static().",
                "Body Parsing - Reading request body data.",
                "express.json() Middleware - Parsing JSON request bodies.",
                "express.urlencoded() - Parsing form data.",
                "Routing Methods - GET, POST, PUT, DELETE.",
                "Status Codes - Setting HTTP status with res.status().",
                "Express Router - Organizing routes into modules.",
                "Error Handling - Basic error middleware.",
                "app.listen() Port - Specifying server port number.",
                "Template Engines - Rendering dynamic HTML (EJS, Pug).",
                "res.render() - Rendering template files.",
                "CORS Basics - Enabling cross-origin requests.",
                "Environment Variables - Using process.env.",
                "RESTful APIs - Creating API endpoints.",
                "Folder Structure - Organizing Express projects.",
                "nodemon - Auto-restarting server on changes.",
            ],
            "tech_allied": [
                "Node.js Basics - Understanding the runtime.",
                "NPM Commands - Installing and managing packages.",
                "package.json - Project configuration.",
                "Postman - Testing API endpoints.",
                "HTTP Methods - GET, POST, PUT, DELETE.",
                "HTTP Status Codes - 200, 201, 404, 500.",
                "REST API Design - Resource-based URLs.",
                "JSON Format - Data exchange format.",
                "Middleware Order - Understanding middleware execution.",
                "Debugging Express - Using console.log and debugger.",
                "Git Basics - Version control.",
                "Environment Setup - Development vs production.",
                "Database Basics - Connecting to databases.",
                "Authentication Basics - User login concepts.",
            ],
        },
        "medium": {
            "tech": [
    ...
    "MERN Stack Developer": {
        "easy": {
            "tech": [
                "What is MERN Stack - MongoDB, Express, React, Node.js together.",
                "MongoDB Basics - NoSQL database for storing documents.",
                "Express Basics - Web framework for Node.js APIs.",
                "React Basics - Library for building user interfaces.",
                "Node.js Basics - JavaScript runtime for backend.",
                "Full Stack Concept - Frontend and backend development.",
                "Client-Server Architecture - How frontend talks to backend.",
                "What is an API - Application Programming Interface for data exchange.",
                "REST API Basics - Standard way to build web APIs.",
                "HTTP Methods - GET, POST, PUT, DELETE operations.",
                "JSON Format - Data format used throughout MERN stack.",
                "Database Collections - Tables in MongoDB.",
                "Database Documents - Records in MongoDB collections.",
                "CRUD Operations - Create, Read, Update, Delete data.",
                "Frontend vs Backend - Client-side vs server-side code.",
                "React Components - Building blocks of React UIs.",
                "React Props - Passing data between components.",
                "React State - Managing component data.",
                "Express Routes - Handling different API endpoints.",
                "Express Middleware - Processing requests.",
                "MongoDB Connection - Connecting Node.js to database.",
                "Mongoose Basics - ODM for MongoDB and Node.js.",
                "Schema Definition - Defining data structure in Mongoose.",
                "Model Creation - Creating database models with Mongoose.",
                "API Endpoints - URLs that handle requests.",
                "Fetching Data - Making API calls from React.",
                "Axios Basics - HTTP client for making requests.",
                "Environment Variables - Storing configuration.",
                "CORS - Allowing frontend to access backend.",
                "Authentication Concept - Verifying user identity.",
                "JWT Basics - JSON Web Tokens for auth.",
                "Form Handling - Capturing user input.",
                "Deployment Basics - Hosting MERN applications.",
            ],
            "tech_allied": [
                "NPM Basics - Package manager for JavaScript.",
                "package.json - Project dependencies and scripts.",
                "Git Basics - Version control fundamentals.",
                "Terminal Commands - Basic command line usage.",
                "Code Editor - VSCode for development.",
                "Debugging Tools - Browser DevTools and console.",
                "Postman - Testing API endpoints.",
                "MongoDB Atlas - Cloud database service.",
                "HTTP Status Codes - Understanding responses.",
                "Project Structure - Organizing MERN projects.",
                "nodemon - Auto-restart development server.",
                "React DevTools - Debugging React applications.",
                "Database Concepts - Basic database terminology.",
                "API Testing - Verifying endpoint functionality.",
            ],
        },
        "medium": {
            "tech": [
